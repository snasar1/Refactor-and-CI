...
def test_not_gate():
    ...
    assert not_gate_output is False
...
def test_nand_gate():
    ...
    assert nand_gate_output is not (nand_gate.get_pin_a() and nand_gate.get_pin_b())
...
def test_nor_gate():
    ...
    assert nor_gate_output is not (nor_gate.get_pin_a() or nor_gate.get_pin_b())
